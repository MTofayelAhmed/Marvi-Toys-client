  ...
  return (
    <div className=" my-10">
      ...
      <div className=" mx-20 grid grid-cols md:grid-cols-2 lg:grid-cols-4 gap-5 avatar my-10">
        <div className="w-44 rounded-full hover:bg-gray-700 bg-sky-800"  data-aos="flip-up">
          <h1 className="text-center pt-20 font-sans font-bold text-white ">
            Age: 2-4 Years
          </h1>
        </div>
        <div className="w-44 rounded-full hover:bg-purple-800 bg-red-900"  data-aos="flip-up">
          <h1 className="text-center pt-20 font-sans font-bold text-white ">
            Age: 4-5 Years
          </h1>
        </div>
        <div className="w-44 rounded-full hover:bg-lime-700 bg-orange-600"  data-aos="flip-up">
          <h1 className="text-center pt-20 font-sans font-bold text-white ">
            Age: 6-7 Years
          </h1>
        </div>
        <div className="w-44 rounded-full hover:bg-blue-700 bg-green-700"  data-aos="flip-up">
          <h1 className="text-center pt-20 font-sans font-bold text-white ">
            Age: 8-13 Years
          </h1>
        </div>
