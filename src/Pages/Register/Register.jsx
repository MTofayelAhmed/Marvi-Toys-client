    ...
    <div className="hero-content flex-col w-full  ">
      ...
      <div className="card shadow-2xl flex-shrink-0  w-full   max-w-xl bg-base-100 ">
        <div className="card-body  ">
          ...
          <small className="text-center mt-6">Already have an account ? please   <button className=" text-red-900 font-bold">
          <Link to='/login'>LogIn</Link>
            </button> </small>

            <button onClick={handleGoogleSignUp} className=" btn  mx-auto text-white mt-6 ">SignUp With Google</button>
        </div>
